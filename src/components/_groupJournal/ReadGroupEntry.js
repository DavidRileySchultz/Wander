...
class ReadGroupEntry extends Component {
  constructor() {
    super();
    this.state = {
      singleEntry: {},
      ...
      <div style={{display: 'flex', 'align-content': 'center', 'justify-content': 'center'}} >    
        {!this.state.loaded ? <div>loading...</div> :
          <PageWrapper>
            ...
            <TitleWrapper>
              <Title>{this.state.singleEntry.groupTitle}</Title>
            ...
            <ContentWrapper>
              ...
              <AnswerWrapper>
                <p>{this.state.singleEntry.groupContent}</p>
              </AnswerWrapper>
            </ContentWrapper>
